...
**Status:** Draft · **Version:** 1.0 · **Companion docs:** `Plotlines_PRD.md` (101 FRs / 98 stories — the source of truth for *what* and *why*), `Plotlines_Research_Spikes.md` (feasibility unknowns to prove before building). This document covers *how*.
