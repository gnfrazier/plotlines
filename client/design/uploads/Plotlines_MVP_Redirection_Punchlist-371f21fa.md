...
☐ **4.34 The find-and-replace test.** Per §0. Run it after every significant editing pass — **and the seed-set test alongside it**: for every enumerated list touched, is the rule behind it stated?
